//! #TwilightGenConfigBuilder
//! 
use llama_cpp_2::sampling::LlamaSampler;

#[derive(Debug, Clone, Default)]
pub struct TwilightGenConfigBuilder {
    temperature: f32,
    top_k: i32,
    top_p: f32,
    is_greedy: bool,
...
impl TwilightGenConfigBuilder {
    ...
    ///
    /// # Example
    /// Demonstrates how to create a sampler using `TwilightGenConfigBuilder`
    /// and apply it to a token data array.
    /// ## ⚠️ Important
    /// This fluent builder is used inside `TwilightModel` to choose **best** the token
    /// ```rust
    /// use twilight_llama::model::gen_config_builder::TwilightGenConfigBuilder;
    ///
    /// let config = TwilightGenConfigBuilder::default().greedy();
    /// ```
...
mod tests {
    ...
    fn get_config() -> TwilightGenConfigBuilder {
        TwilightGenConfigBuilder::default()
    }
